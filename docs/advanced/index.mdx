...
The [conjure-get-started repository](https://github.com/wizardopstech/conjure-get-started/tree/master/templates/) contains the below advanced templates as examples.
