...
| `color_theme` | No | *(default theme)* | Theme name or empty string | Color theme for interactive mode prompts. See [Color Themes](/docs/configuration/themes) for available values. |
...
| `color_theme` | `CONJURE_COLOR_THEME` |
