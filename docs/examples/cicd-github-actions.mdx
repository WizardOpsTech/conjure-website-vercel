...
This example demonstrates how to integrate Conjure into GitHub Actions workflows to automatically generate Kubernetes manifests and deploy applications. The workflow uses the [conjure-get-started](https://github.com/wizardopstechTech/conjure-get-started) remote repository for templates and bundles.
