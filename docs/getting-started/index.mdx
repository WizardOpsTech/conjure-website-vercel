...
```bash
wget https://github.com/wizardopstech/conjure/releases/latest/download/conjure_1.0.0_Darwin_arm64.tar.gz
...
```bash
wget https://github.com/wizardopstech/conjure/releases/latest/download/conjure_1.0.0_Linux_x86_64.tar.gz
