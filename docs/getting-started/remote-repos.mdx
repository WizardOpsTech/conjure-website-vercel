...
This tutorial walks through configuring Conjure to use the [conjure-get-started](https://github.com/wizardopstechTech/conjure-get-started) repository as a remote source, then listing and generating templates from it.
