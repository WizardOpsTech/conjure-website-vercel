...
export default function DonateCard({
  href = "https://donate.conjure.wizardops.dev",
  title = "Support Conjure",
  description = "Your contribution helps sustain development and keeps Conjure free and open source.",
        ...
        <div className={`${s.method} ${s.methodDaf}`}>
          ...
          <div className={s.methodContent}>
            ...
            <span className={s.methodDesc}>
              Use the EIN above and specify &quot;Conjure&quot; as the recipient in the notes
            </span>
          </div>
        </div>
